...
aria-labelledby="sector-tab">
	...
	<div class="list">
		 ...
		 <button type="button" class="btn btn-dark" value="<?php echo $list->list; ?>"
                 id="sector<?php echo $list->id;?>" onclick="delData(this.value,this.id)">削除</button>

                 <button type="submit" class="btn btn-dark" value="sector<?php echo $list->id;?>"
