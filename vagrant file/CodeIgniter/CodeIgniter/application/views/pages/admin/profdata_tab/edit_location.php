<!--所在地-->
        <div class="location-tab">
         ...
         <table id="table_edit">
                ...
                <td>
                 <?php if(isset($formar)){ ?>
                 <input type="text" id="location0" name="location0" class="form-control"
                 value="<?php echo $formar[0]->list; ?>">
                 <?php }else{ ?>
                 <input type="text" id="location0" name="location0" class="form-control"
		 value="<?php echo set_value('location0'); ?>">
                 <span class="text-danger"><?php echo form_error('location0'); ?></span>
                 <?php }?>
                </td>
                </tr>
         ...
         <?php for($j=1;$j<$add_num+1;$j=$j+1){ ?>
                ...
                <td>
                 <input type="text" id="location<?php echo $j;?>" name="location<?php echo $j;?>"
                 value="<?php echo set_value('location'.$j); ?>" class="form-control">
                 <span class="text-danger"><?php echo form_error('location'.$j); ?></span>
                </td>
                </tr>
         <?php } ?>
